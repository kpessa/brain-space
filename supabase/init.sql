...
DROP POLICY IF EXISTS "Users can view own brain dumps" ON brain_dumps;
DROP POLICY IF EXISTS "Users can create own brain dumps" ON brain_dumps;
DROP POLICY IF EXISTS "Users can update own brain dumps" ON brain_dumps;
DROP POLICY IF EXISTS "Users can delete own brain dumps" ON brain_dumps;
...
ALTER PUBLICATION supabase_realtime DROP TABLE IF EXISTS journal_entries;
ALTER PUBLICATION supabase_realtime DROP TABLE IF EXISTS brain_dumps;
...
DO $$
BEGIN
  RAISE NOTICE 'Brain Space database schema created successfully!';
END $$;