...
import { Home, BookOpen, Brain, Clock, Trophy, Sparkles, LogOut, Grid, SunMoon, Calendar } from 'lucide-react'
...
export default function BottomNavigation() {
  ...
  const hideOnRoutes = ['/journal/new', '/journal/edit', '/journal/view', '/auth', '/auth-callback']
      ...
      >
        <div className="flex flex-col h-full pl-safe">
          ...
          <div className="flex items-center justify-center py-3 border-b border-gray-200 dark:border-gray-700">
            <Link
              to="/"
              className="text-brain-600 dark:text-brain-400 hover:text-brain-700 dark:hover:text-brain-300 transition-colors"
            >
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive ? 'text-brain-600 dark:text-brain-400' : 'text-gray-500 dark:text-gray-400'
              )}
            >
              <div
                className={cn(
